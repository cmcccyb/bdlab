...
public class ValidateUtil {
	...
	/**
	 * check the parameters is empty(null || "") or not if has empty return
	 * false,
	 * 
	 * @param param
	 * @return
	...
	public static String checkAppType(String appType) {
		...
		if ("tx".equals(appType) || "ws".equals(appType) || "sleep".equals(appType) || "etcomm".equals(appType)
				|| "chronic".equals(appType))
			app_boolean = true;
