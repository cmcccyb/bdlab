...
import com.bsr.simulator.utils.C3p0Utils;
import com.bsr.simulator.utils.ConfUtil;
...
public class StepcountPackageThread implements Runnable {
	...
	private void sentPackage8One(OutputStream out) throws IOException,
		...
		sendData[8] = 8;
		sendData[9] = 1;
		sendData[10] = 1;//锟斤拷莅锟斤拷锟斤拷停锟斤拷远锟絴锟斤拷锟斤拷
	...
	/**
	 * 锟斤拷锟斤拷8锟脚帮拷锟斤拷细锟斤拷锟� 锟斤拷8小时锟斤拷锟�  8-2
	 * @param out
	 * @throws IOException
	 */
	...
	private void sendPackage8Three(OutputStream out) throws IOException{
		...
		sendData[22] = 60;//锟斤拷锟斤拷
		sendData[23] = 70;//锟斤拷锟斤拷
		sendData[24] = 70;//锟斤拷锟斤拷
