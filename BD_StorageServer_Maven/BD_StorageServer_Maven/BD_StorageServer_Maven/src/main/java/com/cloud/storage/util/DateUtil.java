...
public class DateUtil {
	 ...
	 */
	public static int compareDate(String before, String after, SimpleDateFormat formatter) {
		int ret = 0;
		try {
	 ...
	 */
	public static long getDateIntervalMinus(String begin, String end) throws ParseException {
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		return (formatter.parse(end).getTime() - formatter.parse(begin).getTime()) / 60000;
	}
	...
	public static long getTime(String paramString) throws Exception {
		SimpleDateFormat localSimpleDateFormat = new SimpleDateFormat("yyyyMMddHHmmss");
		long l = localSimpleDateFormat.parse(paramString).getTime();
		return l;
	}
	
	public static String dateToString(String paramString) {
