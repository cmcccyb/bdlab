...
public class PropertiesReader {
	...
	static {
		try {
			InputStream SystemIn = new ClassPathResource("com/cloud/storage/Config/SysConf.properties")
					.getInputStream();
			prop.load(SystemIn);
			InputStream db_config = new ClassPathResource("com/cloud/storage/Config/database.properties")
					.getInputStream();
